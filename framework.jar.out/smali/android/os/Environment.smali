...
.field private static volatile sDedicatedVolume:Landroid/os/storage/StorageVolume;
...
.method private static getDedicatedVolume()Landroid/os/storage/StorageVolume;
    .locals 6

    .prologue
    .line 98
    sget-object v3, Landroid/os/Environment;->sDedicatedVolume:Landroid/os/storage/StorageVolume;
    ...
    invoke-static {v2}, Landroid/os/storage/StorageManager;->getDedicatedVolume([Landroid/os/storage/StorageVolume;)Landroid/os/storage/StorageVolume;

    move-result-object v3

    sput-object v3, Landroid/os/Environment;->sDedicatedVolume:Landroid/os/storage/StorageVolume;
    :try_end_1
...
.method public static isDedicatedStorageExist()Z
    .locals 2

    .prologue
    .line 778
    invoke-static {}, Landroid/os/Environment;->getDedicatedVolume()Landroid/os/storage/StorageVolume;
